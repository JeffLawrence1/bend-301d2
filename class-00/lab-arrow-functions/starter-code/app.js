...
let Student = function (name, age, hometown){  //changed back to working constructor function so that the following steps work properly also according to mdn arrow functions cannot be used as constructors
  this.name = name;
  this.age = age;
...
//so on line 177 the console log for this reports the student object for joe, but when you console log joe.scope on 181 it returns undefined because I believe it is now out of scope and this isn't readable anymore
// 2. What is "this" when joe.scopeArrow() is invoked?
//on line 183 when scopearrow is created this refers to the entire window object however when you console log on 186 again this is now out of scope and is undefined
// 3. Explain why "this" is different when an arrow function is used.
//apparently arrow functions do not bind their own this, so what that means is that when using this in and arrow function it is only referring to the original content, whatever argument/parameter that you passed in to the arrow function.
